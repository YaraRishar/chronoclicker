...
![](Pasted%20image%2020240119225829.png)
...
3. В распакованном архиве лежит main.exe - это и есть кликер (подробнее о его работе рассказано в предыдущем пункте). ![](Pasted%20image%2020240119231200.png)
4. Запустите main.exe, при этом должно появиться окно консоли с надписью "Загрузка..." и окно вебдрайвера. ![](Pasted%20image%2020240119231848.png)
